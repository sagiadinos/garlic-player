...
QT_MOC_LITERAL(3, 44, 14), // "updateFirmware"
QT_MOC_LITERAL(4, 59, 14), // "shutdownPlayer"
QT_MOC_LITERAL(5, 74, 14), // "doSucceedParse"
QT_MOC_LITERAL(6, 89, 15), // "TNetworkAccess*"
QT_MOC_LITERAL(7, 105, 7), // "network"
QT_MOC_LITERAL(8, 113, 22), // "emitApplyConfiguration"
QT_MOC_LITERAL(9, 136, 17), // "emitUpdateFirware"
QT_MOC_LITERAL(10, 154, 18) // "emitShutdownPlayer"

    },
    "SmilHead::TaskScheduler\0applyConfiguration\0"
    "\0updateFirmware\0shutdownPlayer\0"
    "doSucceedParse\0TNetworkAccess*\0network\0"
    "emitApplyConfiguration\0emitUpdateFirware\0"
    "emitShutdownPlayer"
};
...
void SmilHead::TaskScheduler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateFirmware(); break;
        case 2: _t->shutdownPlayer(); break;
        case 3: _t->doSucceedParse((*reinterpret_cast< TNetworkAccess*(*)>(_a[1]))); break;
        case 4: _t->emitApplyConfiguration(); break;
        case 5: _t->emitUpdateFirware(); break;
        ...
        {
            using _t = void (TaskScheduler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskScheduler::updateFirmware)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TaskScheduler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskScheduler::shutdownPlayer)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void SmilHead::TaskScheduler::updateFirmware()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SmilHead::TaskScheduler::shutdownPlayer()
{
