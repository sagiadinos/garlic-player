...
#include "../../src/player-c2qml/media/image.h"
...
QT_MOC_LITERAL(1, 6, 14), // "doStateChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5) // "state"

    },
    "Image\0doStateChanged\0\0state"
};
...
void Image::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doStateChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
