...
#include "../../src/garlic-lib/smilparser/trigger/wallclock.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WallClock_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WallClock_t qt_meta_stringdata_WallClock = {
    {
QT_MOC_LITERAL(0, 0, 9) // "WallClock"
...
QT_INIT_METAOBJECT const QMetaObject WallClock::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_WallClock.data,
    qt_meta_data_WallClock,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *WallClock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WallClock.stringdata0))
