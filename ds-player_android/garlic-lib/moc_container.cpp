...
QT_MOC_LITERAL(1, 11, 20), // "preloadElementSignal"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 11), // "TContainer*"
QT_MOC_LITERAL(4, 45, 11), // "QDomElement"
QT_MOC_LITERAL(5, 57, 26) // "emitfinishedActiveDuration"

    },
    "TContainer\0preloadElementSignal\0\0"
    "TContainer*\0QDomElement\0"
...
void TContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->preloadElementSignal((*reinterpret_cast< TContainer*(*)>(_a[1])),(*reinterpret_cast< QDomElement(*)>(_a[2]))); break;
        case 1: _t->emitfinishedActiveDuration(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TContainer::preloadElementSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TContainer::preloadElementSignal(TContainer * _t1, QDomElement _t2)
{
