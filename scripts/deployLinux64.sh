...
QT_PATH_RUNTIME=$QT_BASE_PATH/$QT_VERSION/gcc_64


echo 
echo ========== enter shadow build dir========== 
echo 
mkdir -p gcc_64-$SHADOW_BUILD_DIR
cd gcc_64-$SHADOW_BUILD_DIR
...
dpkg -b $GARLIC_DEPLOY_BASE_PATH/ $DEPLOY_BASE_NAME-x64.deb

echo 
echo =========== create tar.xz ============ 
echo 
tar -cJf $DEPLOY_BASE_NAME-x64.tar.xz -C deb/garlic-player/opt .
