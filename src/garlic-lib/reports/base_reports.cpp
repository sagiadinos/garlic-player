 ...
 * @param parent
 */
Reporting::Base::Base(TConfiguration *config, QObject *parent) : QObject(parent)
{
 ...
 * @return
 */
QDomElement Reporting::Base::createTagWithTextValue(QString tag_name, QString tag_value)
{
 ...
 * @return
 */
QDomElement Reporting::Base::createPropTag(QString name, QString value)
{
