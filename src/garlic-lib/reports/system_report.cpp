...
Reporting::SystemReport::SystemReport(DiscSpace *disc_space,
                           SystemInfos::Memory *memory,
                           SystemInfos::Network *network,
                           TConfiguration *config,
                           QObject *parent) : Reporting::Base(config, parent)
{
...
void Reporting::SystemReport::process()
{
    init();
    createSystemInfo();
    createNetwork();
...
QString Reporting::SystemReport::asXMLString()
{
    return document.toString();
}


void Reporting::SystemReport::createSystemInfo()
{
...
void Reporting::SystemReport::createNetwork()
{
...
void Reporting::SystemReport::createConfiguration()
{
    configuration = document.createElement("configuration");
    system_info.appendChild(configuration);
}

void Reporting::SystemReport::createModelInfo()
{
...
void Reporting::SystemReport::createFactoryDefault()
{
...
void Reporting::SystemReport::createUserPref()
{
...
void Reporting::SystemReport::createHardwareInfo()
{
...
void Reporting::SystemReport::appendNetworkChilds()
{
...
void Reporting::SystemReport::appendNetworkAddressChilds()
{
